    ...
    return {
      ...
      tech: [
        ...
        },
        {
          id: 7,
          name: 'C++',
          imageUrl: 'https://images.app.goo.gl/BHhh4fWubnp8Yzwx8'
          status: 'Intermediate'
        }
      ],
      tools: [
      ...
      <section
        ...
        <div class="flex justify-center">
          <img class="w-9/12 rounded-full mb-3 fadein-up"
            src="https://yt3.ggpht.com/teOpIxmeanVVK6l81MlRWgwAhl_pXqM9JBnovYRhtyIbk6c_hTJ1Pi6mhmwqtl_iGq_4EiJD7Q=s600-c-k-c0x00ffffff-no-rj-rp-mo" alt="Foto">
        </div>
        <div class="md:w-7/12">
